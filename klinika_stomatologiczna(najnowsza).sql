...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 05, 2024 at 03:08 PM
...
CREATE TABLE `historia_chorob_pacjentow` (
  `id_choroby` int(10) NOT NULL,
  `id_pacjenta` int(10) DEFAULT NULL,
...
CREATE TABLE `historia_lekow_pacjentow` (
  `id_historia_leku` int(10) NOT NULL,
  `id_pacjenta` int(10) DEFAULT NULL,
...
CREATE TABLE `historia_platnosci` (
  `id_platnosci` int(10) NOT NULL,
  `id_wizyty` int(10) DEFAULT NULL,
  `data_platnosci` date DEFAULT NULL,
  `kwota_platnosci` int(6) DEFAULT NULL,
...
(1, 'Adam', 'Noga', '1990-05-15', 'ul. Kwiatowa 5, Warszawa', 723847106, 8270729942),
(2, 'Anna', 'Stara', '1985-12-20', 'ul. Słoneczna 10, Kraków', 104274926, 81100451433),
(3, 'Piotr', 'Podolski', '1978-07-03', 'ul. Leśna 7, Gdańsk', 567890123, 60121622145),
(4, 'Karolina', 'Biała', '1993-09-28', 'ul. Polna 15, Poznań', 234567890, 81042981795),
(5, 'Michał', 'Gwóźdź', '1980-04-12', 'ul. Zielona 3, Wrocław', 496283654, 72070694526),
(6, 'Magdalena', 'Sucharek', '1975-11-07', 'ul. Parkowa 12, Łódź', 487623947, 61072261528),
(7, 'Kamil', 'Król', '1991-02-19', 'ul. Szkolna 8, Katowice', 987495623, 74081274861),
(8, 'Aleksandra', 'Królik', '1987-06-25', 'ul. Ogrodowa 6, Gdynia', 891385734, 87062818934),
(9, 'Marek', 'Wieczorek', '1983-08-30', 'ul. Jesienna 9, Szczecin', 757127687, 50072064293),
(10, 'Natalia', 'Plak', '1995-01-10', 'ul. Morska 4, Lublin', 672498476, 7240557129);
...
CREATE TABLE `recepty` (
  ...
  `nazwa_leku` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `dawkowanie` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `numer_recepty` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 2, '2024-04-20', 'Paracetamol', '3 tabletki w przypadku bólu', 196378),
(2, 4, '2024-04-21', 'Ibuprofen', '1 tabletka co 6 godzin', 409644),
(3, 6, '2024-04-22', 'Fluor', 'Nakładać na zęby przed snem', 569484),
(4, 8, '2024-04-23', 'Chlorheksydyna', 'Płukać jamę ustną 2 razy dziennie', 942685),
(5, 1, '2024-04-24', 'Amoksycylina', '2 tabletki dziennie po posiłku', 301286),
(6, 3, '2024-04-25', 'Fluor', 'Nakładać na zęby przed snem', 192582),
(7, 5, '2024-04-26', 'Antybiotyk', 'Zgodnie z zaleceniami lekarza', 108406),
(8, 7, '2024-04-27', 'Octenisept', 'Płukać jamę ustną 3 razy dziennie', 184603),
(9, 9, '2024-04-28', 'Leki przeciwbólowe', 'Zgodnie z zaleceniami lekarza', 208632),
(10, 10, '2024-04-29', 'Ibuprofen', '1 tabletka co 6 godzin', 946784);
...
CREATE TABLE `stan_magazynowy_lekow` (
  `id_stan_mag_leku` int(10) NOT NULL,
  `nazwa_leku` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci DEFAULT NULL,
  `ilosc_dostepna` int(6) DEFAULT NULL,
...
CREATE TABLE `wizyty` (
  ...
  `koszt_wizyty` int(7) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `zaplanowane_zabiegi` (
  `id_zabiegu` int(10) NOT NULL,
  `id_wizyty` int(10) DEFAULT NULL,
  `id_procedury` int(10) DEFAULT NULL,
